...
export function Hero() {
  return <section className="py-12 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <img src="/chatgpt_01.png" alt="A woman enjoying her morning coffee with a warm smile after finding relief from chronic pain" className="w-full rounded-lg shadow-lg mb-8" />
