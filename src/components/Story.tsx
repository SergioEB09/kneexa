    ...
    <section className="bg-white py-10 px-4">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="flex items-center space-x-2 mb-6">
          ...
          <span className="text-sm uppercase tracking-wide text-[#666666] whitespace-nowrap px-4">
            Her Story
          </span>
          <div className="border-l-4 border-[#E5E0DC] flex-grow"></div>
        </div>
        ...
        <p className="text-lg leading-relaxed mb-6 font-serif italic">
          It was 7:50 AM on a Tuesday when Linda Martinez realized she had become “that woman.”
        </p>
        ...
        {/* She Was Tired List */}
        <div className="bg-gray-50 rounded-lg p-6 mb-8 border-l-4 border-[#D66A5E]">
        ...
        <p className="text-lg leading-relaxed mb-6">
          That’s when Linda discovered the <strong>Kneexa Relief System</strong>.
        </p>
        <p className="text-lg leading-relaxed mb-6">
        ...
        <p className="text-lg leading-relaxed mb-6">
          Today, she hikes with her husband, chases her grandchildren, and moves with the confidence of a woman half her age.
        </p>
